...
namespace gtirb
{
    namespace schema
    {
        ...
        {
            static constexpr const char* Name = "dwarfSections";
            typedef std::map<gtirb::UUID, std::tuple<uint64_t, uint64_t>> Type;
        };

        /// \brief Auxiliary data covering ELF section properties.
        struct FlaggedSymbols
        {
            static constexpr const char* Name = "flaggedSymbols";
        ...
        struct AllSections
        {
            static constexpr const char* Name = "allSections";
            typedef std::map<gtirb::UUID, std::tuple<uint64_t, uint64_t>> Type;
        };
